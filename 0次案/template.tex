...
VNEアルゴリズムの実装と性能を評価するシミュレータである\cite{forth}．
ALEVINは，物理ネットワークとVN要求を生成し，
...
評価するため，AcceptedVnrRatio，CostRevenueを用いる．
...
\subsection{考察}
\noindent　寺生手法は，多くの条件で高いAcceptedVnrRatioを示し，
