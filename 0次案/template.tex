...
\noindent
各実験条件について5回の実験を行い，
受理率，CostRevenue，実行時間の平均値を求めた．
図\ref{fig:accepted}に受理率，
図\ref{fig:costrevenue}にCostRevenue，
図\ref{fig:time}に実行時間を示す．
各図の横軸は実験条件を表す．
横軸の上段は物理ノード数を示し，
...
\begin{figure}[tb]
  ...
  \includegraphics[width=0.52\textwidth,
    height=5cm,
    keepaspectratio]{accepted_ratio.pdf}
...
\begin{figure}[tb]
  ...
  \includegraphics[width=0.52\textwidth,
    height=5cm,
    keepaspectratio]{execution_time.pdf}
...
\begin{figure}[tb]
  ...
  \includegraphics[width=0.52\textwidth,
    height=5cm,
    keepaspectratio]{cost_revenue.pdf}
